...
for i in subject_list: 
    ...
    emg_data["subject{}".format(i)]["ex2"]= spio.loadmat("D:\datasets\s{}\S{}_A1_E2.mat".format(i,i),variable_names = "emg") #load files from stored location 
    emg_data["subject{}".format(i)]["ex3"]= spio.loadmat("D:\datasets\s{}\S{}_A1_E2.mat".format(i,i),variable_names = "emg")#load files from stored location 
    ...
    emg_data["subject{}".format(i)]["ex2"]["r"]= spio.loadmat("D:\datasets\s{}\S{}_A1_E2.mat".format(i,i),variable_names= "restimulus")
    ...
    emg_data["subject{}".format(i)]["ex3"]["r"] = spio.loadmat("D:\datasets\s{}\S{}_A1_E3.mat".format(i,i),variable_names = "restimulus")
